      ...
      <div className="section-wrapper">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-card p-8 md:p-12 rounded-2xl border border-dog-primary/30 mb-12 relative overflow-hidden opacity-0 animate-slide-in">
            {/* Price tag */}
            <div className="absolute top-6 right-6 glass-card bg-gradient-to-r from-dog-primary to-dog-secondary p-4 rounded-xl transform rotate-3 shadow-lg">
              <div className="text-center">
                <div className="text-lg font-medium mb-1">Apenas</div>
                <div className="text-4xl font-bold mb-1">R$27</div>
            ...
            <div className="mb-12 max-w-2xl">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>Um saco de ração</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="h-6 w-6 bg-dog-primary/20 rounded-full flex items-center justify-center text-dog-primary flex-shrink-0">
                    <Check className="h-4 w-4" />
                  </div>
                  <span>Uma multa de síndico</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="h-6 w-6 bg-dog-primary/20 rounded-full flex items-center justify-center text-dog-primary flex-shrink-0">
                    <Check className="h-4 w-4" />
                  </div>
                  <span>O estresse mental de viver no caos</span>
                </li>
              </ul>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {bonuses.map((bonus, index) => (
                  <div key={index} className="glass-card p-6 rounded-xl flex gap-3 items-start">
                    ...
                    <div className="text-lg">{bonus}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold mb-6 flex items-center gap-2">
                ...
                <span>Garantia de Risco Zero:</span>
              </h3>
              <div className="glass-card p-6 rounded-xl bg-dog-primary/10 border border-dog-primary/20">
                <p className="text-lg mb-4">
                  Se em 7 dias você aplicar o protocolo e seu cachorro não melhorar,
            ...
            <div className="text-center mt-10">
              ...
              <Button className="shine-btn w-full sm:w-auto py-8 px-12 text-xl rounded-xl animate-pulse-glow">
